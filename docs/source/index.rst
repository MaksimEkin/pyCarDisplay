...
.. code-block:: python
    ...
    display = CarDisplay(
        # Kitti dataset path: https://s3.eu-central-1.amazonaws.com/avg-kitti/raw_data/2011_09_26_drive_0005/2011_09_26_drive_0005_sync.zip
        ...
        # Object detection model downloaded from https://drive.google.com/open?id=1bvJfF6r_zYl2xZEpYXxgb7jLQHFZ01Qe
        object_detection_model_path="checkpoint_ssd300.pth.tar",
        # Depth detection model downloaded from https://github.com/intel-isl/MiDaS/releases/download/v2_1/model-f6b98070.pt
