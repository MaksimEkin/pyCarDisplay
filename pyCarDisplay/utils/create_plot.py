...
class KalmanPlot():
    ...
    def gen_plot(self, prediction, true_value):
        ...
        plot = plt.plot(self.kalman_predictions, label='Kalman signal', linestyle="solid", color="#cc5f43")
        plot = plt.plot(self.true_values, label='Ground truth', linestyle="dashed", color="#8176cc")

        plt.title("Kalman Plot for: " + str(self.plot_column), fontsize="large", color="white")
